...
export async function GET() {
  try {
    ...
    const products = await Product.find({ status: 'active' })
      .select('-details -metatitle -metadescription -categories -status -categoryName -metakeywords -metacanonical -metalanguage -metaschema -otherMeta -msds -spec -url -priority -lastmod -changeFreq -createdAt -updatedAt')
      .lean().limit(10);
